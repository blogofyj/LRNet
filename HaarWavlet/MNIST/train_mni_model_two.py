...
# netG.load_state_dict(torch.load('/remote-home/cs_igps_yangjin/MyVae3/HaarWavlet/MNIST/Mnist_Result_One/params_2.pt'))
...
# optimizer_G = torch.optim.Adam(optim_params, lr=0.01, weight_decay=1e-8, betas=(0.9, 0.999))
