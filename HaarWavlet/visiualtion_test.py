...
# netG.load_state_dict(torch.load('/remote-home/cs_igps_yangjin/MyVae3/HaarWavlet/InvDN_Result/params_pause.pt'))
# netG.load_state_dict(torch.load('/remote-home/cs_igps_yangjin/MyVae3/HaarWavlet/InvDN_Result/params_58.pt')) #86
netG.load_state_dict(torch.load('/remote-home/cs_igps_yangjin/MyVae3/HaarWavlet/InvDN_Result/params_86.pt')) #86
netG = netG.cuda()
