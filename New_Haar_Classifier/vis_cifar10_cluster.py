...
cifar_10_dir = '/remote-home/cs_igps_yangjin/MyVae3/cifar10/train_data/cifar-10-batches-py'
...
targets = list(map(str, range(11)))
colors = ['r', 'g', 'b', 'y', 'black', 'c', 'm', 'k', 'w', 'orange']
